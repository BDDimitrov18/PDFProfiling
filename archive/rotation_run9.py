...
def corroborate_tesseract(img) -> tuple[bool, int | None, float] | None:
    ...
    # OSD orientation is the clockwise rotation of the page text.
    # Map to counter-clockwise (CCW) convention used by this codebase.
    _OSD_TO_CCW = {0: 0, 90: 270, 180: 180, 270: 90}
